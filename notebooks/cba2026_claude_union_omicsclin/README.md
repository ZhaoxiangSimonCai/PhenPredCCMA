...
- **SHAP suite** (Figs 1–8): which features the model learns to use, mapped
  back to known biology. Outputs at `reports/cba2026_claude_union_omicsclin/shap_analysis/20260511_174623/`.
- **Prediction suite** (Figs P1–P11): how well TabPFN+MOSA predicts vs RF on
  ...
  itself faithful. Outputs at `reports/cba2026_claude_union_omicsclin/prediction_analysis/20260511_174623/`.
...
Composite figures live directly in `reports/cba2026_claude_union_omicsclin/shap_analysis/<TIMESTAMP>/`. Single-panel slide-friendly versions of every panel live alongside in `…/singles/` (see below).
...
Composites at `reports/cba2026_claude_union_omicsclin/prediction_analysis/<TIMESTAMP>/`. Single-panel slide-friendly exports under `…/singles/`.
...
d = Path('reports/cba2026_claude_union_omicsclin/shap_analysis/20260511_174623')
...
```
cd notebooks/cba2026_claude_union_omicsclin
